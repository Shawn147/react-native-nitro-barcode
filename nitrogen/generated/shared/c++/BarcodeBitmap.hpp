...
namespace margelo::nitro::barcode {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BarcodeBitmap).
   */
  struct BarcodeBitmap final {
  public:
  ...
  public:
    BarcodeBitmap() = default;
    explicit BarcodeBitmap(double width, double height, std::shared_ptr<ArrayBuffer> data): width(width), height(height), data(data) {}

  public:
    friend bool operator==(const BarcodeBitmap& lhs, const BarcodeBitmap& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ BarcodeBitmap <> JS BarcodeBitmap (object)
  template <>
  struct JSIConverter<margelo::nitro::barcode::BarcodeBitmap> final {
    static inline margelo::nitro::barcode::BarcodeBitmap fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::barcode::BarcodeBitmap(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::barcode::BarcodeBitmap& arg) {
